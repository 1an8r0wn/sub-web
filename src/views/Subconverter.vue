        ...
        remoteConfig: [
          {
            ...
            options: [
              {
                label: "默认",
                value: "https://gcore.jsdelivr.net/gh/son-g0ku/ACL4SSR@master/Clash/config/ACL4SSR_Online_Full_NoAuto.ini"
              },
              {
                label: "默认（自动测速）",
                value: "https://gcore.jsdelivr.net/gh/son-g0ku/ACL4SSR@master/Clash/config/ACL4SSR_Online_Full_AdblockPlus.ini"
              },
              {
